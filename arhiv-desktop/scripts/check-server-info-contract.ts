 ...
 *
 * How:
 * 1) Verify the CLI server module (`arhiv-cli/src/bin/arhiv/server.rs`) emits the exact
...
const rustCliPath = path.join(repoRoot, 'arhiv-cli', 'src', 'bin', 'arhiv', 'server.rs');
