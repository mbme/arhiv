...
const ICONS = {
  ...
  'link-arrow': (className: string) => (
    // heroicons mini arrow-top-right-on-square
  ...
  'x': (className: string) => (
    <svg className={cx('icon', className)} viewBox="0 0 24 24" fill="none" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
    </svg>
  ),
  'spinner': (className: string) => (
    <svg
      className={cx('icon text-gray-200 animate-spin dark:text-gray-600 fill-blue-600', className)}
      viewBox="0 0 100 101"
      fill="none"
    >
      <path
  ...
  'clipboard-check': (className: string) => (
  ...
  'dots-horizontal': (className: string) => (
  ...
  'search-catalog': (className: string) => (
  ...
  'browse-catalog': (className: string) => (
  ...
  'pencil-square': (className: string) => (
  ...
  'erase-document': (className: string) => (
  ...
  'duplicate-document': (className: string) => (
  ...
  'chevron-up': (className: string) => (
    ...
    <svg className={cx('icon', className)} fill="currentColor" viewBox="0 0 24 24">
      <path
        fillRule="evenodd"
  ...
  'task-list': (className: string) => (
    // material design icons order-bool-ascending-variant
    <svg className={cx('icon', className)} viewBox="0 0 24 24" fill="currentColor">
  ...
  'file-cabinet': (className: string) => (
    // material design icons file-cabinet
    <svg className={cx('icon', className)} viewBox="0 0 24 24" fill="currentColor">
  ...
  'book-open': (className: string) => (
    // material design icons book-open-variant-outline
    <svg className={cx('icon', className)} viewBox="0 0 24 24" fill="currentColor">
  ...
  'game': (className: string) => (
    // material design icons gamepad-variant-outline
    <svg className={cx('icon', className)} viewBox="0 0 24 24" fill="currentColor">
  ...
  'contact': (className: string) => (
    // material design icons account-box-outline
    <svg className={cx('icon', className)} viewBox="0 0 24 24" fill="currentColor">
...
export const ICON_VARIANTS = Object.keys(ICONS) as ReadonlyArray<IconVariant>;
...
export function Icon({ variant, className = '' }: IconProps) {
  return ICONS[variant](className);
}
