...
Proposed features belong in issues or proposed architecture decisions, not in
the topic documents.
...
| Protected assets, attackers, guarantees, and residual risks | [System threat model](system-threat-model.md) |
